...
import com.company.cobranca.service.CadastroTituloService;
...
public class TituloController {
	...
	public String salvar(@Validated Titulo titulo, Errors errors, RedirectAttributes redirect) {
		if (errors.hasErrors()) {
	...
	public String excluir (@PathVariable Long codigo, RedirectAttributes redirect){
		...
		redirect.addFlashAttribute("mensagem", "Título excluído com sucesso!");
